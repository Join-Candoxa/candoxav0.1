// components/landing/MadeFor.tsx — Made for every kind of builder
'use client'
    ...
    <section className="bg-black py-20 md:py-28 px-5 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-6 items-start">
          ...
          >
            ...
            <h2 className="text-4xl font-black leading-tight mb-4" style={{ fontFamily: 'Syne, sans-serif' }}>
              Made for every<br />kind of builder
            </h2>
          </motion.div>
          ...
          <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {audiences.map((a, i) => (
              <motion.div
                ...
                className="bg-[#0A0A0F] border border-white/[0.08] rounded-2xl p-6 hover:border-blue-500/30 transition-colors"
              >
                <div className="w-10 h-10 bg-blue-900/50 rounded-xl flex items-center justify-center mb-4">
                  <span className="text-blue-400 text-base">{a.icon}</span>
                </div>
        ...
        <motion.div
          ...
          className="mt-10 md:mt-8 md:pl-[calc(33.333%+24px)]"
        >
          <a href="/onboarding" className="text-white/50 text-sm hover:text-white transition-colors">
